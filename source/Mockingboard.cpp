...
void poll_mockingboard (int samples, int16_t *buffer)
{
	if (!MockingboardVoice.bActive)
		return;
...
void MB_Initialize()
{
	...
	ra2::log_cb(RETRO_LOG_INFO, "MB_Initialize: g_bDisableDirectSound=%d, g_bDisableDirectSoundMockingboard=%d\n", g_bDisableDirectSound, g_bDisableDirectSoundMockingboard);
	...
	else
	{
		...
		ra2::log_cb(RETRO_LOG_INFO, "MB_Initialize: AY8910_InitAll()\n");
		...
		ra2::log_cb(RETRO_LOG_INFO, "MB_Initialize: MB_DSInit(), g_bMBAvailable=%d\n", g_bMBAvailable);

		MB_Reset(true);
		ra2::log_cb(RETRO_LOG_INFO, "MB_Initialize: MB_Reset()\n");
	}
}
