...
std::string Card::GetCardName(const SS_CARDTYPE cardType)
{
	...
	//nao-case CT_Uthernet:
	//nao-	return Uthernet1::GetSnapshotCardName();
	case CT_FourPlay:
	...
	//nao-case CT_Uthernet2:
	//nao-	return Uthernet2::GetSnapshotCardName();
	default:
		return "Unknown";
	}
}
...
SS_CARDTYPE Card::GetCardType(const std::string & card)
{
	...
	//nao-else if (card == Uthernet1::GetSnapshotCardName())
	//nao-{
	//nao-	return CT_Uthernet;
	//nao-}
	...
	//nao-else if (card == Uthernet2::GetSnapshotCardName())
	//nao-{
	//nao-	return CT_Uthernet2;
	//nao-}
	else
	{
