...
//		{TEXT("ZPLOAD")      , CmdZeroPageLoad      , CMD_ZEROPAGE_POINTER_LOAD  , "Load zero page pointers"                }, // Cant use as param to ZP
		...
		{TEXT("OPEN")        , CmdDisksetOpen       , CMD_DISKSET_OPEN           , "Open disk set"                          },
		{TEXT("USE")         , CmdDisksetUse        , CMD_DISKSET_USE            , "Use disk set"                           },
		{TEXT("LIST")        , CmdDisksetList       , CMD_DISKSET_LIST           , "List disk set items"                    },
		{TEXT("D1")          , CmdDisksetD1         , CMD_DISKSET_D1             , "Insert disk to drive 1"                 },
		{TEXT("D2")          , CmdDisksetD2         , CMD_DISKSET_D2             , "Insert disk to drive 2"                 },
...
//		{TEXT("REGISTERS")  , NULL, PARAM_CAT_REGISTERS   },
		...
		{"DISKSET"     , NULL, PARAM_CAT_DISKSET     },
// Memory
