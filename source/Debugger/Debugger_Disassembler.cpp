...
{
	int nLen = 16 + g_nDisasmCurLine * 3; // max 3 opcodes/instruction, is our search window
...
// a.
			...
			if (iLine == 0) first_nOpbytes = nOpbytes;
			if (iAddress == g_nDisasmCurAddress) advance_bytes = first_nOpbytes;
